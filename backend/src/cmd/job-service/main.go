...
// App manages the lifecycle of the job service.
type App struct {
	cfg          *config.Config
...
func (a *App) Init() error {
	...
	// Initialize OpenTelemetry metric pipeline for job-service
...
func (a *App) Run() error {
	...
	// messages, not lifecycle events. job-service publishes RequestMsg to
